...
import fixtures.compute.implementation.RestorePointsImpl;
...
public final class RestorePointsAsyncClient {
    private final RestorePointsImpl serviceClient;

    /**
     * Initializes an instance of RestorePoints client.
     *
     * @param serviceClient the service client implementation.
     */
    RestorePointsAsyncClient(RestorePointsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> createWithResponse(
        ...
        return this.serviceClient.createWithResponseAsync(
                resourceGroupName, restorePointCollectionName, restorePointName, parameters, requestOptions);
    }
    ...
    public Mono<Response<Void>> deleteWithResponse(
        ...
        return this.serviceClient.deleteWithResponseAsync(
                resourceGroupName, restorePointCollectionName, restorePointName, requestOptions);
    }
