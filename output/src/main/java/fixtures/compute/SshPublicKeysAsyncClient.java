...
public final class SshPublicKeysAsyncClient {
    ...
    public Mono<Response<BinaryData>> createWithResponse(
        ...
        return this.serviceClient.createWithResponseAsync(
                resourceGroupName, sshPublicKeyName, parameters, requestOptions);
    }
    ...
    public Mono<Response<Void>> deleteWithResponse(
        ...
        return this.serviceClient.deleteWithResponseAsync(resourceGroupName, sshPublicKeyName, requestOptions);
    }
    ...
    public Mono<Response<BinaryData>> getWithResponse(
            String resourceGroupName, String sshPublicKeyName, RequestOptions requestOptions) {
        return this.serviceClient.getWithResponseAsync(resourceGroupName, sshPublicKeyName, requestOptions);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> generateKeyPairWithResponse(
            String resourceGroupName, String sshPublicKeyName, RequestOptions requestOptions) {
        return this.serviceClient.generateKeyPairWithResponseAsync(resourceGroupName, sshPublicKeyName, requestOptions);
    }
}
