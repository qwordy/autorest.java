...
public final class VirtualMachineScaleSetExtensionsImpl {
    ...
    public Response<Void> deleteWithResponse(
            ...
            RequestOptions requestOptions,
            Context context) {
        return deleteWithResponseAsync(resourceGroupName, vmScaleSetName, vmssExtensionName, requestOptions, context)
                .block();
    }
    ...
    public Response<BinaryData> getWithResponse(
            ...
            RequestOptions requestOptions,
            Context context) {
        return getWithResponseAsync(resourceGroupName, vmScaleSetName, vmssExtensionName, requestOptions, context)
                .block();
    }
    ...
    public PagedFlux<BinaryData> listAsync(
        ...
        return new PagedFlux<>(
                () -> listSinglePageAsync(resourceGroupName, vmScaleSetName, requestOptions),
    ...
    public PagedFlux<BinaryData> listAsync(
            String resourceGroupName, String vmScaleSetName, RequestOptions requestOptions, Context context) {
        return new PagedFlux<>(
                () -> listSinglePageAsync(resourceGroupName, vmScaleSetName, requestOptions, context),
    ...
    public PagedIterable<BinaryData> list(
            String resourceGroupName, String vmScaleSetName, RequestOptions requestOptions) {
        return new PagedIterable<>(listAsync(resourceGroupName, vmScaleSetName, requestOptions));
    }
    ...
    public PagedIterable<BinaryData> list(
            String resourceGroupName, String vmScaleSetName, RequestOptions requestOptions, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, vmScaleSetName, requestOptions, context));
    }
